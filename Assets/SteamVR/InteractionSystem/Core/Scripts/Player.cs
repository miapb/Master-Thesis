...
namespace Valve.VR.InteractionSystem
{
	...
	public class Player : MonoBehaviour
	{
		...
		public GameObject mainMenuParentVR;
		public GameObject mainMenuParent2DFallback;
		...
		//-------------------------------------------------
		private Transform savedMainMenuTransformVR;
		private RectTransform savedMainMenuRectTransformVR;
		private IEnumerator Start()
		{
			_instance = this;

			savedMainMenuTransformVR = mainMenu.transform;
			savedMainMenuRectTransformVR = mainMenu.GetComponent<RectTransform>();
		...
		private void ActivateRig( GameObject rig )
		{
			...
			if ( rig == rigSteamVR )
			{
				mainMenu.transform.parent = mainMenuParent2DFallback.transform;
				mainMenu.GetComponent<RectTransform>().localPosition = savedMainMenuRectTransformVR.localPosition;
				mainMenu.GetComponent<RectTransform>().localRotation = savedMainMenuRectTransformVR.localRotation;
            }
            else
            {
				mainMenu.transform.parent = mainMenuParent2DFallback.transform;
				mainMenu.GetComponent<RectTransform>().localPosition = new Vector3(-279, 65, -144);
				mainMenu.GetComponent<RectTransform>().localRotation = Quaternion.Euler(0, 0, 0);
			}
